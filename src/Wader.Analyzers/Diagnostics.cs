...
internal static class Diagnostics
{
    ...
    public const string IdVirtualComponentBaseFunctionsShouldBeCalled = "WADER004";
    ...
    public static readonly RazorDiagnosticDescriptor VirtualComponentBaseFunctionsShouldBeCalled = new(
        IdVirtualComponentBaseFunctionsShouldBeCalled,
        () => "All components overriding a virtual method from component base should call the base implementation",
        RazorDiagnosticSeverity.Warning
    );
}
