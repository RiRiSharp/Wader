...
public partial class BsProgress : BsChildContentComponent
{
    ...
    protected override void OnParametersSet()
    {
        ...
        _ = ValueNow ?? throw new ArgumentException(message: "Value must be provided.", nameof(ValueNow));
        var min = ValueMin ?? throw new ArgumentException(message: "Value must be provided.", nameof(ValueMin));
        var max = ValueMax ?? throw new ArgumentException(message: "Value must be provided.", nameof(ValueMax));
